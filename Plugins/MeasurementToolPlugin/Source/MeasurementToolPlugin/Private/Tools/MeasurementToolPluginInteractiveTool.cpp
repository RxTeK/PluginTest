...
#include "MeasurementToolPluginInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UMeasurementToolPluginInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UMeasurementToolPluginInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UMeasurementToolPluginInteractiveTool* NewTool = NewObject<UMeasurementToolPluginInteractiveTool>(SceneState.ToolManager);
...
UMeasurementToolPluginInteractiveToolProperties::UMeasurementToolPluginInteractiveToolProperties()
{
...
void UMeasurementToolPluginInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UMeasurementToolPluginInteractiveTool::Setup()
{
	...
	Properties = NewObject<UMeasurementToolPluginInteractiveToolProperties>(this, "Measurement");
...
void UMeasurementToolPluginInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UMeasurementToolPluginInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UMeasurementToolPluginInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UMeasurementToolPluginInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UMeasurementToolPluginInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UMeasurementToolPluginInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UMeasurementToolPluginInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UMeasurementToolPluginInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UMeasurementToolPluginInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
