...
#include "MeasurementToolPluginInteractiveTool.generated.h"


/**
 * Builder for UMeasurementToolPluginInteractiveTool
 */
UCLASS()
class MEASUREMENTTOOLPLUGIN_API UMeasurementToolPluginInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UMeasurementToolPluginInteractiveTool
 */
UCLASS(Transient)
class MEASUREMENTTOOLPLUGIN_API UMeasurementToolPluginInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UMeasurementToolPluginInteractiveToolProperties();
...
/**
 * UMeasurementToolPluginInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class MEASUREMENTTOOLPLUGIN_API UMeasurementToolPluginInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UMeasurementToolPluginInteractiveToolProperties> Properties;
